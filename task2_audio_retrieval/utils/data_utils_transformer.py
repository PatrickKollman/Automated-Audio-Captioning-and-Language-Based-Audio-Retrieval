...
class QueryAudioDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        query = torch.as_tensor(item[self.query_col])
...
def collate_fn(data_batch):
    ...
    query_batch = torch.vstack(query_batch)
    return audio_feat_batch.float(), audio_feat_lens, query_batch, 0, info_batch
