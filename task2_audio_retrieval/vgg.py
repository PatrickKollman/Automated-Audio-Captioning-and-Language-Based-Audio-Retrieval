...
from utils import data_utils_vgg
...
# Load data
text_datasets, vocabulary = data_utils_vgg.load_data(training_config["train_data"])
...
for split in ["train", "val", "test"]:
    ...
    _loader = DataLoader(dataset=_dataset, batch_size=BATCH_SIZE,
                          shuffle=True, collate_fn=data_utils_vgg.collate_fn)
