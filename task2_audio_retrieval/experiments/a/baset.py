...
model2 = torch.load(model_dir + 'model.pth', map_location=device)
model.load_state_dict(model2)
"""
outfile = open(info_dir + "logs2.txt", 'w')
...
for epoch in range(100):
  ...
  torch.save(model.state_dict(), model_dir + "model2_" + str(epoch+1) + ".pth")
